  ...
  <div ref="top">
    ...
    <v-row v-if="!loading" style="background-color: #fff; border-radius: 10px" class="p-4 shadow">
      ...
      <div style="display: flex; justify-content: center">
        <v-radio-group v-model="$v.editedItem.period_by.$model" row>
          <!-- radio hours -->
      ...
      <!-- dates col -->
      <v-col cols="12" sm="12" md="12" v-show="editedItem.period_by == 'days'">
      ...
      <v-col cols="12" sm="12" md="4" class="m-0 pb-3">
        <base-input label="Asignado por" v-model="$v.editedItem.assigned_by.$model"
          :validation="$v.editedItem.assigned_by" validationTextType="none" />
      </v-col>
      <!-- assigned_by -->
