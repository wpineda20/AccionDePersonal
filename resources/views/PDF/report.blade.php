...
<body>
    <div class="border">
        ...
        <table style="padding: 0px; margin:0px; width: 100%;">
            ...
            <tr style="padding: 0px; margin:0px">
                ...
                <td style="padding: 0px; margin:0px">
                    <p style="border-bottom: 1px solid black; margin:0px 20px 0px 0px; padding:0px;"
                        class="fs-11 uppercase">{{ $ap->position_signature }}
                    </p>
                </td>
            </tr>
            <tr style="padding: 0px; margin:0px">
                ...
                <td style="padding: 0px; margin:0px">
                    <p style="border-bottom: 1px solid black; margin:0px 20px 0px 0px; padding:0px;"
                        class="fs-11 uppercase">{{ $ap->dependency_name }}</p>
                </td>
            </tr>
        </table>
        <!-- I- DATOS GENERALES -->
            ...
            <tr style="padding: 0px; margin:0px">
                ...
                <td style="padding: 0px; margin:0px">
                    <p style="border-bottom: 1px solid black; margin:0px 20px 0px 0px;" class="fs-11 uppercase">
                        {{ $ap->justification_name }}
                    </p>
                </td>
            </tr>
        </table> -->
        <p class="fs-11 uppercase" style="">{{ $ap->justification_name }}</p>
        <!-- II- NATURALEZA DE LA LICENCIA POR -->
            ...
            <tr style="padding: 0px; margin:0px">
                <td style="padding: 0px; margin:0px; border-right: 1px solid black;">
                    ...
                    <p style="padding: 0px; margin:4px 0px" class="fs-10 text-center">
                        Total de horas: <span
                            style="border-bottom: 1px solid black; padding: 0px 25px;">{{ $ap->total_hours }}
                        </span>
                    </p>
                    <p style="padding: 0px; margin:4px 0px" class="fs-10 text-center">
                        EFECTIVA PARA FECHA:<span
                            style="border-bottom: 1px solid black; padding: 0px 25px;">{{ $ap->effective_date }}
                        </span>
                    </p>
                </td>
                <td style="padding: 0px; margin:0px">
                    ...
                    <p style="padding: 0px; margin:4px 0px;" class="fs-10  text-center">
                        Total de días <span
                            style="border-bottom: 1px solid black; padding: 0px 40px 0px 65px;">{{ $ap->total_days }}
                        </span>
                    </p>
                </td>
            </tr>
        ...
        <!-- IV- JUSTIFICANTES -->
        <h5 class="fw-bold fs-10 bg-border" style="padding: 0px; margin:4px 0 0 0;">IV- JUSTIFICANTES: (cuando aplique)
        </h5>
        <table style="padding: 0px; margin:0px;">
            <tr>
                <td style="height: 50px; vertical-align: top;">
                    <p class="fs-11 uppercase">
                        {{ $ap->justification }}</p>
                </td>
            </tr>
        </table>
    ...
    <div>
        <h5 class="fw-bold fs-10 bg-border"
            style="border-right: 1px solid black; border-left: 1px solid black; margin: 0; padding:0px;">VI.
            FIRMAS</h5>
        <table style="width: 100% !important;  border: 1px solid; border-collapse: collapse;">
            ...
            <tr style="margin: 0; padding:0px; border: 1px solid; wi">
                <td height="100" style="border: 1px solid; width: 50% !important">
                    <img src="img/cuadro.png" style="width: 100%;" height="100" />
                </td>
                <td height="100" style="border: 1px solid; width: 50% !important">
                    <img src="img/cuadro.png" style="width: 100%;" height="100" />
                </td>
            ...
            <tr style="margin: 0; padding:0px;">
                <td style="border: 1px solid; width: 100% !important" colspan="2">
                    <h5 class="fw-bold fs-9 text-center" style="margin: 0; padding:0px">
            ...
            <tr style="margin: 0; padding:0px; border: 1px solid;">
                <td height="100" style="border: 1px solid; width: 100% !important" colspan="2">
                    <img src="img/cuadro.png" style="width: 100%;" height="100" />
                </td>
            </tr>
